...
namespace DotNetty.Codecs.Http.Tests.Cors
{
    ...
    public sealed class CorsHandlerTest
    {
        ...
        public void PreflightDeleteRequestWithCustomHeaders()
        {
            ...
            Assert.Equal("http://localhost:8888", response.Headers.Get(HttpHeaderNames.AccessControlAllowOrigin, null).ToString());
            ...
            Assert.Equal(HttpHeaderNames.Origin.ToString(), response.Headers.Get(HttpHeaderNames.Vary, null).ToString());
        }
